  ...
  <div class="sec-inner">
    ...
    <div class="lp-banner">
      <div>
        ...
        <p class="lp-banner-desc">Empieza a aparecer y a atraer tus primeros clientes: 4 videos + 4 imágenes + 4 historias al mes, con Meta Ads gestionados: campañas de conversión segmentadas (4 anuncios) y app de avance.</p>
      </div>
    ...
    <div class="lp-grid">
      <article class="lp-card popular">
        ...
        <ul class="lp-feats">
          ...
          <li>Meta Ads gestionados: <strong>8 anuncios</strong>&nbsp;con retargeting + Píxel</li>
      ...
      <article class="lp-card">
        ...
        <ul class="lp-feats">
          ...
          <li>Meta Ads completo: <strong>12 anuncios</strong>&nbsp;con A/B testing + remarketing</li>
