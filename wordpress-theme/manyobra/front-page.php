...
<section class="profile-sec" id="perfil">
  <div class="sec-inner">
    <div class="sec-tag">Sobre mí</div>
    <h2>Detrás de <span class="accent">Manyobra</span></h2>
    <p class="sec-sub">Estrategia y producción con nombre y apellido, sin intermediarios.</p>
  ...
  <div class="sec-inner">
    ...
    <div class="lp-banner">
      <div>
        ...
        <p class="lp-banner-desc">¿Recién estás partiendo? 1 video + 2 fotos + 2 diseños = 5 piezas de contenido al mes. Sin gestión de Ads.</p>
      </div>
    ...
    <div class="lp-grid">
      <article class="lp-card">
        ...
        <ul class="lp-feats">
          <li><strong>8 piezas</strong>&nbsp;de contenido al mes</li>
          <li>2 videos · 3 fotos · 3 diseños</li>
          <li>Meta Ads gestionados + Píxel</li>
          <li>Community Manager + reporte mensual</li>
        </ul>
        <a href="https://wa.me/56956747949?text=Hola%20Manyobra%2C%20quiero%20el%20Plan%20Impulso" target="_blank" rel="noopener" class="lp-cta ghost">Quiero este plan →</a>
      </article>
      ...
      <article class="lp-card popular">
        ...
        <ul class="lp-feats">
          <li><strong>14 piezas</strong>&nbsp;de contenido al mes</li>
          <li>4 videos · 4 fotos · 6 diseños + sesión de producción</li>
          <li>Meta Ads completo + remarketing</li>
          <li>Landing page + copywriting de ventas</li>
        </ul>
        <a href="https://wa.me/56956747949?text=Hola%20Manyobra%2C%20quiero%20el%20Plan%20Turbo" target="_blank" rel="noopener" class="lp-cta grad">Quiero este plan →</a>
      </article>

      <article class="lp-card">
        <div class="lp-badge ghost">Premium</div>
        <div class="lp-name">⚡ Manyobra</div>
        <p class="lp-desc">Tu sistema de ventas automatizado trabajando 24/7.</p>
        <div class="lp-price"><span class="n">$500.000</span><span class="p">/mes + IVA</span></div>
        <ul class="lp-feats">
          <li><strong>28 piezas</strong>&nbsp;de contenido al mes</li>
          <li>10 videos · 8 fotos · 10 diseños + 2 sesiones</li>
          <li>Meta Ads avanzado + A/B testing</li>
          <li>Bot de WhatsApp de ventas 24/7</li>
        </ul>
        <a href="https://wa.me/56956747949?text=Hola%20Manyobra%2C%20quiero%20el%20Plan%20Manyobra" target="_blank" rel="noopener" class="lp-cta ghost">Quiero este plan →</a>
      </article>
    </div>
    ...
    <div class="footer-top">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="planes.html">⚡ Manyobra</a></li>
